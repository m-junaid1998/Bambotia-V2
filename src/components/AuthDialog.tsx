...
import { AUTH_DIALOG_TRIGGER } from "@/hooks/useCart"; 
...
const AuthDialog = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(AUTH_DIALOG_TRIGGER, openDialog);
    return () => {
      window.removeEventListener(AUTH_DIALOG_TRIGGER, openDialog);
    };
  }, []);
        ...
        <div className="flex flex-col items-center gap-4 py-2">
          ...
          <DialogHeader className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground tracking-wide leading-relaxed">
              Please sign up or log in to your account to manage your cart, save premium products, and access your wishlist storefront.
            </p>
          </DialogHeader>
